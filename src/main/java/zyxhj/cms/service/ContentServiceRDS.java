...
public class ContentServiceRDS {
	 ...
	 * 添加内容
	 */
	public Content addContent(DruidPooledConnection conn, String module, Byte type, Byte status, Byte power,Long upUserId, Long upChannelId,
			String title,String tags, String data,String proviteData,String ext) throws Exception {
	 ...
	 * 修改内容
	 */
	public Content editContent(DruidPooledConnection conn,Long id, String module, Byte type, Byte status, Byte power,Long upUserId, Long upChannelId,
			String title, String data,String proviteData,String ext) throws Exception {
		Content c = new Content();
		c.moduleId = module;
	 ...
	 */
	public List<Content> searchContents(DruidPooledConnection conn, Byte type,Byte status,int count,int offset) throws ServerException {
