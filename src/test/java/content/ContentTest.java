...
//
//		try {
//			Content1 cnt = contentService.createContentPublished(conn, Content1.TYPE.H5.v(), 1L, 1L, "testh5",
//					"{\"data\":\"sdfksdf\"}");
//
...
//		try {
//
//			List<Content1> lc = contentService.queryContentsByTags(conn, null, null, null, null, "kind_type",
